...
<link
    href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@700&family=Oswald:wght@700;800&family=Poppins:wght@400;600;700;800&display=swap"
    rel="stylesheet">
...
<style>
    ...
    .design10-wrapper .design10-green-band {
        ...
        height: 144px;
        /* FIX: was 34% of unknown → 34% of 425 = 144px */
    ...
    .design10-wrapper .design10-arrow-tl {
        position: absolute;
        top: 110px;
        /* FIX: was 26% of 425 = ~110px */
        left: 20px;
        /* FIX: was 6% of 340 = ~20px */
        z-index: 5;
        width: 44px;
        /* FIX: was 13% of 340 = ~44px */
        height: 44px;
    }

    .design10-wrapper .design10-arrow-tl svg {
        width: 44px;
        height: 44px;
    }
    ...
    .design10-wrapper .design10-arrow-br svg {
        width: 44px;
        height: 44px;
    }
    ...
    .design10-wrapper .design10-bottom-area {
        ...
        right: 0;
        height: 90px;
        /* FIX 5: explicit — prevents overflow */
        z-index: 5;
        display: flex;
    ...
    .design10-wrapper .design10-phone-number {
        ...
        width: 100%;
        white-space: nowrap;
        /* single line — card is fixed 340px */
        overflow: hidden;
    ...
    .design10-wrapper .design10-download-btn:hover {
        background: #4a7520;
        transform: translateY(-1px);
    }

    .design10-wrapper .design10-download-btn:active {
        transform: translateY(0);
    }

    .design10-wrapper .design10-download-btn:disabled {
        opacity: 0.7;
        cursor: not-allowed;
        transform: none;
    }
...
<div class="design10-wrapper">
    ...
    <div class="design10-card" id="posterCard10">
        ...
        <svg class="design10-texture-bg" width="340" height="425" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="d10DiamondTile" x="0" y="0" width="24" height="24" patternUnits="userSpaceOnUse">
                    <line x1="0" y1="0" x2="24" y2="24" stroke="rgba(0,0,0,0.045)"
                        stroke-width="0.7" />
                    <line x1="24" y1="0" x2="0" y2="24" stroke="rgba(0,0,0,0.045)"
                        stroke-width="0.7" />
                ...
                <pattern id="d10OuterDiamond" x="0" y="0" width="48" height="48" patternUnits="userSpaceOnUse">
                    <polygon points="24,2 46,24 24,46 2,24" fill="none" stroke="rgba(90,138,42,0.07)"
                        stroke-width="0.9" />
                    <polygon points="24,10 38,24 24,38 10,24" fill="none" stroke="rgba(0,0,0,0.04)"
                        stroke-width="0.7" />
                    <line x1="24" y1="2" x2="24" y2="10" stroke="rgba(0,0,0,0.035)"
                        stroke-width="0.6" />
                    <line x1="46" y1="24" x2="38" y2="24" stroke="rgba(0,0,0,0.035)"
                        stroke-width="0.6" />
                    <line x1="24" y1="46" x2="24" y2="38" stroke="rgba(0,0,0,0.035)"
                        stroke-width="0.6" />
                    <line x1="2" y1="24" x2="10" y2="24" stroke="rgba(0,0,0,0.035)"
                        stroke-width="0.6" />
                    <circle cx="24" cy="24" r="2" fill="none" stroke="rgba(90,138,42,0.09)"
                        stroke-width="0.8" />
                ...
                <pattern id="d10Hatch" x="0" y="0" width="8" height="8" patternUnits="userSpaceOnUse">
                    <line x1="0" y1="8" x2="8" y2="0" stroke="rgba(0,0,0,0.028)"
                        stroke-width="0.5" />
                </pattern>
            </defs>
        ...
        <div class="design10-arrow-tl">
            <svg viewBox="0 0 55 55" xmlns="http://www.w3.org/2000/svg">
                <path d="M 10 10 Q 8 35 30 44" fill="none" stroke="#1a1a1a" stroke-width="2.5"
                    stroke-linecap="round" />
                <path d="M 22 44 L 30 44 L 28 36" fill="none" stroke="#1a1a1a" stroke-width="2.5"
        ...
        <div class="design10-arrow-br">
            <svg viewBox="0 0 55 55" xmlns="http://www.w3.org/2000/svg">
                <path d="M 45 10 Q 48 36 25 44" fill="none" stroke="#1a1a1a" stroke-width="2.5"
                    stroke-linecap="round" />
                <path d="M 33 44 L 25 44 L 27 36" fill="none" stroke="#1a1a1a" stroke-width="2.5"
                    stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        </div>
        ...
        <div class="design10-bottom-area">
            <div class="design10-bottom-row">
                <div class="design10-order-btn"><span
                        style="color: #ffffff !important; font-weight:700 !important ; font-size:8px !important;">ORDER
                        NOW</span> </div>
            </div>
            <div class="design10-phone-number">{{ @user()->name ?? ' ' }}</div>
            <div class="design10-phone-address">{{ @user()->website_domain ?? ' ' }} | {{ @user()->phone ?? ' ' }} |
                {{ @user()->address ?? ' ' }}</div>
        </div>
