...
<style>
    ...
    .design9-wrapper .dot-pattern-bl svg {
        width: 100%;
        height: 100%;
        display: block;
    }
    ...
    .design9-wrapper .dot-pattern-tr svg {
        width: 100%;
        height: 100%;
        display: block;
    }
    ...
    .design9-wrapper .d9-download-btn:hover {
        background: #aa0d0d;
        transform: translateY(-1px);
    }

    .design9-wrapper .d9-download-btn:active {
        transform: translateY(0);
    }

    .design9-wrapper .d9-download-btn:disabled {
        opacity: 0.7;
        cursor: not-allowed;
        transform: none;
    }
    ...
    <div class="design9-card" id="posterCard9">
        ...
        <div class="d9-plate-wrap">
            <div class="d9-plate-circle">
                ...
                @else
                    <img src="https://images.unsplash.com/photo-1544025162-d76694265947?w=700&q=85"
