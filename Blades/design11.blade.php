    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@700&family=Pacifico&family=Poppins:wght@300;400;600;700;800;900&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        .design11-wrapper .design11-download-btn:hover {
            opacity: 0.92;
            transform: translateY(-1px);
        }

        .design11-wrapper .design11-download-btn:active {
            transform: translateY(0);
        }

        .design11-wrapper .design11-download-btn:disabled {
            opacity: 0.6;
            cursor: not-allowed;
            transform: none;
        }
        ...
        <div class="design11-card" id="posterCard11">
            ...
            <div class="design11-tech-ring">
                <svg viewBox="0 0 410 410" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="205" cy="205" r="190" fill="none" stroke="{{ $themeColor }}4d"
                        stroke-width="1.5" stroke-dasharray="6 4" />
                    <circle cx="205" cy="205" r="175" fill="none" stroke="{{ $themeColor }}26"
                        stroke-width="1" />
                    <circle cx="205" cy="205" r="155" fill="none" stroke="{{ $themeColor }}1a"
                        stroke-width="0.8" />
                    ...
                    <circle cx="205" cy="205" r="140" fill="rgba(20,15,0,0.25)"
                        stroke="{{ $themeColor }}33" stroke-width="1" />
                </svg>
            </div>
            ...
            <div class="design11-dots-layer">
                ...
                <div class="design11-dot"
                    style="width:3px;height:3px;top:40%;left:5%;background:{{ $themeColor }}99;"></div>
                <div class="design11-dot"
                    style="width:3px;height:3px;top:35%;right:5%;background:{{ $themeColor }}99;"></div>
            </div>
            ...
            <div class="design11-logo-wrap">
                @if (isset($logourl) && $logourl)
                    <img src="{{ $logourl }}" alt="logo" class="design11-top-logo"
